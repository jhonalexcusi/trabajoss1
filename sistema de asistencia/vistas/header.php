...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b></b> ESCUELA</span>
    </a>
...
if ($_SESSION['acceso']==1) {
  echo '  <li class="treeview">
        ...
        <li><a href="https://www.compartiendocodigos.com/" target="_blanck"><i class="fa  fa-exclamation-circle"></i> <span>Acerca de</span><small class="label pull-right bg-yellow">escuela12</small></a></li>   
